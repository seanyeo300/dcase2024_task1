...
if __name__ == "__main__":
    ...
    script_name = 'run_passt_KD_Cochl_TAU_FT_subsets_DIR_FMS_h5_tv3.py'
    ...
    ckpt_experiment_pairs = [
        ...
        # ("f5hhbj59", "NTU_KD_Var3b-T_FTtau-S_FMS_DIR_sub5_fixh5")       #FTtau
        # (None, "NTU_KD_Var3b-T_PTas-S_FMS_DIR_sub5_fixh5")            #Ptau
    ]
