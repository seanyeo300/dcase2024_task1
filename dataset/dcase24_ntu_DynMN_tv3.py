...
dataset_config = {
    ...
    "logits_file": os.path.join("predictions","ensemble", "sub5_DyMN20_TA3.pt") # TA3->Dy10/BCBL
    # "logits_file": os.path.join("predictions","ensemble", "sub5_DyMN20_NOAS_TA3.pt") # TA3->DyMN15/10 
