...
dataset_config = {
    ...
    # "logits_file": os.path.join("predictions","ensemble", "sub5_ensemble_6_model_tv2c.pt") # tv2c 
    ...
    #sub10
    # "logits_file": os.path.join("predictions","ensemble", "sub10_ensemble_6_PASST_tv1.pt") # 
