...
# meta_csv = r"F:\CochlScene\meta.csv"
meta_csv = r"D:\Sean\CochlScene\meta.csv"
...
train_files_csv = r"D:\Sean\github\cpjku_dcase23_NTU\split_setup\splitcochl.csv"
...
dataset_dir = r"D:\Sean\CochlScene"
...
hf = h5py.File('h5py_cochl_train_mel_10s_128bins', 'w')
for file_idx in tqdm(range(len(files))):
