...
if __name__ == "__main__":
    ...
    base_args = ['--gpu','[0]',"--subset", "5", "--dir_prob", "0.6", "--mixstyle_p", "0.4", "--batch_size", "48","--model_name", "dymn20_as", "--model_width", "2.0"]
    ...
    ckpt_experiment_pairs = [
        ...
        (None, "tDynMN20_FTtau_32K_FMS_DIR_noAS_sub5_fixh5")                       #FTtau_noASpt 
