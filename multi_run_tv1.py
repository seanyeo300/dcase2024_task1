...
if __name__ == "__main__":
    ...
    base_args = ['--gpu','[0]',"--subset", "5", "--dir_prob", "0.6", "--mixstyle_p", "0.4","--kd_lambda","0.07","--temperature","3","--logit_stand"]#, "--batch_size", "48","--pretrained","--model_name", "dymn10_as"] # this is for the KD process, does not apply to teachers!!! "--logit_stand"
    ...
    ckpt_experiment_pairs = [
        ...
        (None, "NTU_KD_3SIT3BCBL-T_32BCBL-S_FMS_DIR_stand_T=3_lmbda=0.07_sub5_fixh5")          # DCASE SIT BCBL logit stand, T=3, lmbda=0.05
