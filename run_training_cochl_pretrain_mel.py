...
from dataset.cochl_ntu_teacher_10s import ntu_get_training_set_dir, ntu_get_test_set, ntu_get_eval_set, open_h5, close_h5
...
if __name__ == '__main__':
    ...
    parser.add_argument('--experiment_name', type=str, default="NTU_cochlpretrain_DSP_441K_DIR_FMS_32_channel_10s_h5")
