...
from dataset.cochl_ntu_teacher import ntu_get_training_set_dir, ntu_get_test_set, ntu_get_eval_set, open_h5, close_h5
...
def evaluate(config):
    ...
    # Open h5 file once
    hf_in = open_h5('h5py_cochl_wav')
    eval_hf = open_h5('h5py_cochl_eval_wav')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--experiment_name', type=str, default="NTU_cochlpretrain_DSP_441K_DIR_FMS_32_channel_h5")
