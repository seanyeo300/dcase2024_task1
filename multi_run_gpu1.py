...
if __name__ == "__main__":
    # Example: Replace these with your actual script names and arguments
    scripts_to_run = [
        # ('run_training_FMS_DIR.py', ['--ckpt_id', None, "--experiment_name", "tBCBL_sub5_441K_32_channel_STtau_nh5"]),
        ('run_training_FMS_DIR.py', ['--ckpt_id', None, "--experiment_name", "tBCBL_sub5_441K_24_channel_STtau_nh5"]),
        ('run_training_FMS_DIR.py', ['--ckpt_id', None, "--experiment_name", "tBCBL_sub5_441K_32_channel_STtau_nh5"])
    ]
    run_multiple_scripts(scripts_to_run)