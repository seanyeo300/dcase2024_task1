...
from dataset.dcase24_ntu_teacher_tDSIT_sub10 import ntu_get_training_set_dir, ntu_get_test_set, ntu_get_eval_set, open_h5, close_h5
...
if __name__ == '__main__':
    ...
    parser.add_argument('--experiment_name', type=str, default="NTU_Var3b-T_32BCBL-S_FMS_DIR_sub5_fixh5")
