...
if __name__ == "__main__":
    ...
    scripts_to_run = [
        ('run_training_KD_logit_stand_h5_tv1.py', ['--evaluate', '--ckpt_id', 'iqahdgms', '--sample_rate', '44100']),
        ('run_training_KD_logit_stand_h5_tv1.py', ['--evaluate', '--ckpt_id', "5if10nhu", '--sample_rate', '44100']),
        ('run_training_KD_logit_stand_h5_tv1.py', ['--evaluate', '--ckpt_id', 'qkzlhzyb', '--sample_rate', '44100']),
        ('run_training_KD_logit_stand_h5_tv1.py', ['--evaluate', '--ckpt_id', '55quevwg', '--sample_rate', '44100']),
