...
from dataset.dcase24_dev import get_training_set, get_test_set, get_eval_set, dataset_config
...
class PLModule(pl.LightningModule):
    def __init__(self, config):
        ...
        self.epoch_activation_maps = []  # To accumulate activation maps during testing
        ...
        with torch.set_grad_enabled(True):
            if self.config.Cam:
                with torch.enable_grad():
                    # Forward pass through mel transformation in float32
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt_id', type=str, default='iqahdgms')  # for loading trained model, corresponds to wandb id
    # GRADCAM
