...
if __name__ == '__main__':
    ...
    parser.add_argument('--experiment_name', type=str, default="DCASE24_KDF_Ensemble2Base_Ali1_sub5_lmda=0.04")
    ...
    parser.add_argument('--kd_lambda', type=float, default=0.04) # default is 0.02
